        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  mx-auto ">
              ...
              <li class="nav-item">
                <a class="nav-link" href="Guest/About.html">About</a>
              </li>
              
            </ul>
            <div class="user_option">
              <a href="Guest/User.php" class="user_link">
                <i class="fa fa-user" aria-hidden="true"></i>
              </a>
             
              <a href="Guest/Login.php" class="order_online">
                Sign In
              </a>
            </div>
          </div>
              ...
              <div class="row">
                <div class="col-md-7 col-lg-6 ">
                  <div class="detail-box">
                    ...
                    <div class="btn-box">
                      <a href="Guest/Login.php" class="btn1">
                        Order Now
                      </a>
                    </div>
                  </div>
        ...
        <div class="owl-carousel client_owl-carousel">
          <div class="item">
            <div class="box">
              ...
              <div class="img-box">
                <img src="Assets/Template/Main/images/client1.jpg" alt="" class="box-img">
              </div>
            </div>
          </div>
          <div class="item">
            <div class="box">
              ...
              <div class="img-box">
                <img src="Assets/Template/Main/images/client2.jpg" alt="" class="box-img">
              </div>
            </div>
          </div>
        </div>
